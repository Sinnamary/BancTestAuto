"""
Vue onglet Enregistrement — maquette (graphique vide ou factice).
"""
...
class LoggingView(QWidget):
    ...
    def _build_ui(self):
        ...
        # Précision : ce qui est enregistré
        info = QLabel(
            "Enregistrement des mesures du multimètre OWON à intervalle régulier : valeur, unité et mode "
            "(tension, courant, température, etc.) dans un fichier CSV horodaté. Le générateur n’est pas enregistré."
        )
        ...
        config_layout.addWidget(QComboBox())  # s / min / h
        ...
        # Zone graphique factice (placeholder)
